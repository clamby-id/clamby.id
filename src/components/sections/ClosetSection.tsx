...
const ClosetSection = () => {
  return (
    <section
      className="py-16 lg:py-24 bg-linear-tox-b from-background to-chart-2/25"
      id="features"
    >
      <div className="container flex flex-col gap-8 mx-auto px-4 md:px-20 lg:px-24 max-w-6xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-2 md:gap-4">
          <Card className="col-span-1 md:col-span-2 flex-col md:flex-row justify-between">
            <CardDescription className="md:max-w-72 flex flex-col ">
          ...
          <Card className="col-span-1 md:col-span-2 lg:col-span-3 flex-col  md:flex-row  md:items-center justify-between">
